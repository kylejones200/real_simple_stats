...
class TestGeometricBrownianMotion:
    ...
    def test_invalid_S0(self):
        ...
        with pytest.raises(ValueError, match="S0 must be positive"):
            geometric_brownian_motion(S0=-100, mu=0.10, sigma=0.20, T=1.0)
    ...
    def test_invalid_T(self):
        ...
        with pytest.raises(ValueError, match="T must be positive"):
            geometric_brownian_motion(S0=100, mu=0.10, sigma=0.20, T=0)
...
class TestMonteCarloFromData:
    ...
    def test_basic_simulation(self):
        ...
        result = monte_carlo_from_data(
            data=data, n_steps=30, n_simulations=100, random_seed=42
        )
    ...
    def test_insufficient_data(self):
        ...
        with pytest.raises(ValueError, match="at least 2 values"):
            monte_carlo_from_data(data=[100], n_steps=30, n_simulations=100)
